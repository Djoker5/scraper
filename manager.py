    ...
    if a == 1:
        ...
        if float(version.text) > 0.9:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/Djoker5/manager.py/blob/main/adder.py')
                os.system('curl -l -O https://raw.githubusercontent.com/manager.py/blob/main/manager.py')
